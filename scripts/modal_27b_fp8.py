"""
Paganini AIOS — Qwen3.5 27B FP8 on Modal (L40S 48GB)
Official FP8 quantization — near-identical to BF16 quality
"""
import modal

MODEL_NAME = "Qwen/Qwen3.5-27B-FP8"
MODEL_DIR = "/models/qwen35-27b-fp8"

app = modal.App("paganini-27b-fp8")
